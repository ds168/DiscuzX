...
(
	...
	'suggestion' => '如果您是站点管理员，建议您尝试在管理中心 <a href="admin.php?action=tools&operation=updatecache&frames=yes" target="_blank">更新缓存</a> ，或凭完整截图通过 <a href="https://www.dismall.com/" target="_blank" rel="noreferrer">官方论坛</a> 寻求帮助。如果您确定是程序自身Bug，您也可直接 <a href="https://gitee.com/discuz/DiscuzX/issues" target="_blank" rel="noreferrer">提交Issue</a> 给我们',
